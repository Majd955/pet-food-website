...
<head>
    ...
    <title>Корма для кошек - Cat & Dog Food Manufacturer</title>
        ...
        <section class="content">
            ...
            <div class="product-grid">
                <div class="product-card">
                    <img src="images/cat1.png" alt="Cat Food 1">
                    <h3>Беззерновой корм для кошек</h3>
                    <p>Натуральные ингредиенты, без ГМО.</p>
                    <button>Купить сейчас</button>
                </div>
                <div class="product-card">
                    <img src="images/cat2.png" alt="Cat Food 2">
                    <h3>Корм для кошек с курицей</h3>
