...
<head>
    ...
    <title>О нас - Cat & Dog Food Manufacturer</title>
...
<body class="about-us">
    ...
    <main>
        <section class="content">
            <h1>О нас</h1>
            <p>Мы - производитель высококачественных кормов для кошек и собак. Наша миссия - забота о здоровье ваших питомцев.</p>
        </section>
    </main>
    <footer>
